...
OBJ_DEBUG = $(OBJDIR_DEBUG)/UserHistory.o $(OBJDIR_DEBUG)/Rules.o $(OBJDIR_DEBUG)/RandomEntity.o $(OBJDIR_DEBUG)/Offer.o $(OBJDIR_DEBUG)/Log.o $(OBJDIR_DEBUG)/KompexSQLiteStatement.o $(OBJDIR_DEBUG)/utils/GeoIPTools.o $(OBJDIR_DEBUG)/utils/base64.o $(OBJDIR_DEBUG)/utils/UrlParser.o $(OBJDIR_DEBUG)/utils/SearchEngines.o $(OBJDIR_DEBUG)/utils/Cookie.o $(OBJDIR_DEBUG)/src/GeoRerions.o $(OBJDIR_DEBUG)/src/CHiredis.o $(OBJDIR_DEBUG)/main.o $(OBJDIR_DEBUG)/Config.o $(OBJDIR_DEBUG)/DBAccessor/anet.o $(OBJDIR_DEBUG)/DB.o $(OBJDIR_DEBUG)/Core.o $(OBJDIR_DEBUG)/CgiService.o $(OBJDIR_DEBUG)/CampaignShowOptions.o $(OBJDIR_DEBUG)/Campaign.o $(OBJDIR_DEBUG)/KompexSQLiteDatabase.o $(OBJDIR_DEBUG)/InformerTemplate.o $(OBJDIR_DEBUG)/Informer.o $(OBJDIR_DEBUG)/HistoryManager.o $(OBJDIR_DEBUG)/BaseCore.o $(OBJDIR_DEBUG)/FullTextSearcher/XXXSearcher.o $(OBJDIR_DEBUG)/FullTextSearcher/SearcherWrapper.o $(OBJDIR_DEBUG)/DataBase.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/UserHistory.o $(OBJDIR_RELEASE)/Rules.o $(OBJDIR_RELEASE)/RandomEntity.o $(OBJDIR_RELEASE)/Offer.o $(OBJDIR_RELEASE)/Log.o $(OBJDIR_RELEASE)/KompexSQLiteStatement.o $(OBJDIR_RELEASE)/utils/GeoIPTools.o $(OBJDIR_RELEASE)/utils/base64.o $(OBJDIR_RELEASE)/utils/UrlParser.o $(OBJDIR_RELEASE)/utils/SearchEngines.o $(OBJDIR_RELEASE)/utils/Cookie.o $(OBJDIR_RELEASE)/src/GeoRerions.o $(OBJDIR_RELEASE)/src/CHiredis.o $(OBJDIR_RELEASE)/main.o $(OBJDIR_RELEASE)/Config.o $(OBJDIR_RELEASE)/DBAccessor/anet.o $(OBJDIR_RELEASE)/DB.o $(OBJDIR_RELEASE)/Core.o $(OBJDIR_RELEASE)/CgiService.o $(OBJDIR_RELEASE)/CampaignShowOptions.o $(OBJDIR_RELEASE)/Campaign.o $(OBJDIR_RELEASE)/KompexSQLiteDatabase.o $(OBJDIR_RELEASE)/InformerTemplate.o $(OBJDIR_RELEASE)/Informer.o $(OBJDIR_RELEASE)/HistoryManager.o $(OBJDIR_RELEASE)/BaseCore.o $(OBJDIR_RELEASE)/FullTextSearcher/XXXSearcher.o $(OBJDIR_RELEASE)/FullTextSearcher/SearcherWrapper.o $(OBJDIR_RELEASE)/DataBase.o
...
$(OBJDIR_DEBUG)/Rules.o: Rules.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c Rules.cpp -o $(OBJDIR_DEBUG)/Rules.o
...
$(OBJDIR_RELEASE)/Rules.o: Rules.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c Rules.cpp -o $(OBJDIR_RELEASE)/Rules.o
