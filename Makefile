...
RESINC = 
LIBDIR = 
LIB =  -lmongoclient -lfcgi -lsphinxclient -lGeoIP -lrabbitmq -lboost_date_time -lboost_regex -licui18n -licuuc -licudata -ltinyxml -lsqlite3 -lboost_system
