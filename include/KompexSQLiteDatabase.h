...
public:
    ...
    */
    ...
    {
        return mDatabaseHandle;
    }
    //! Returns the versionnumber of sqlite.
    inline int GetLibVersionNumber() const
    {
    ...
    {
        return sqlite3_changes(mDatabaseHandle);
    }
    ...
    {
        return sqlite3_total_changes(mDatabaseHandle);
    }
    ...
    {
        sqlite3_interrupt(mDatabaseHandle);
    }
    ...
    {
        return sqlite3_get_autocommit(mDatabaseHandle);
    }
    ...
    //! Output: std::cout
    inline void ActivateTracing() const
    {
        sqlite3_trace(mDatabaseHandle, &Kompex::SQLiteDatabase::TraceOutput, 0);
    }
    ...
    //! Note: time in ns\n
    //! Output: std::cout
    inline void ActivateProfiling() const
    {
        sqlite3_profile(mDatabaseHandle, &Kompex::SQLiteDatabase::ProfileOutput, 0);
    }
    ...
    inline void SetSoftHeapLimit(int heapLimit) const
    {
        sqlite3_soft_heap_limit(heapLimit);
    }
    ...
    inline int ReleaseMemory(int bytesOfMemory) const
    {
    ...
    {
        sqlite3_db_release_memory(mDatabaseHandle);
    }
